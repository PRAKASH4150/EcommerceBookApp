...
namespace EcommerceBookApp.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            //Checking if roles exists in the DB and creating it if not
        ...
        private ApplicationUser CreateUser()
        {
            try
            {
				...
				return Activator.CreateInstance<ApplicationUser>(); //For custom application user.
			}
            catch
            {
